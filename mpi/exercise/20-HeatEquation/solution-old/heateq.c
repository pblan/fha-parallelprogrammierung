...
int main(int argc, char* argv[]) 
{
  ...
  if (0==procRank)
  {
    ...
    double* uk0 = malloc(nLocal*sizeof(double));
    double* uk1 = malloc(nLocal*sizeof(double));

    InitFields(uk0,uk1,NX+1, 0,TempLeft, NX,TempRight, TempMid);

    WriteFile("data0", uk1,0.0, 0,NX+1);
    ...
    WriteFile("dataS", uk1,0.0, 0,NX+1);
